...
export const getFCMToken = async () => {
  ...
  try {
    ...
    try {
      ...
      console.log('에러 타입:', nativeError.name);
      console.log('에러 메시지:', nativeError.message);
      
      if (nativeError.stack) {
        console.log('스택 트레이스:', nativeError.stack);
      }
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
      
      // iOS 시뮬레이터 체크
      if (Platform.OS === 'ios' && nativeError.message) {
        const errorMsg = nativeError.message.toLowerCase();
        if (errorMsg.includes('simulator') || 
          ...
          console.log('에러:', nativeError.message);
          console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    ...
    const expoProjectId = Constants.expoConfig?.extra?.eas?.projectId || 
      ...
      projectId: expoProjectId,
        ...
        console.error('❌ Expo Push Token 발급도 실패:', expoError.message);
        throw expoError;
      }
    }
  } catch (error) {
    ...
    if (error.message && error.message.includes('aps-environment')) {
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
export const registerFCMTokenToServer = async (fcmToken) => {
  try {
    if (!fcmToken) {
